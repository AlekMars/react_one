...
export default () => {
    ...
    const handler = (e) => {
        ...
        let body = {
            ...
            wight: wight || "unknown",
            stock:stock || 0,
            description: description || "Тут скоро появиться описание товара",
            discount: discount,
            pictures: pictures
        }
        console.log(body);
    ...
    <Form onSubmit={handler}>
        <Row>
            ...
            <Col xs={12} md={6}>
                <div className="form-preview mb-2" style={{backgroundImage: pictures ? `url(${pictures})`: "url(https://pusat.edu.np/wp-content/uploads/2022/09/default-image.jpg)"}}/>
                <Form.Group className="mb-3">
